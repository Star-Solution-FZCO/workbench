...
const themeOptions: ThemeOptions & CustomThemeOptions = {
    breakpoints: {
        values: {
            xs: 0,
            sm: 600,
...
export const theme = createTheme(themeOptions) as CustomTheme;

export const useReactSelectStyles = makeStyles((theme: CustomTheme) => ({
    reactSelect: {
        width: "100%",
        ...
        "&__control--is-focused, &__control--menu-is-open": {
            "&:after": {
